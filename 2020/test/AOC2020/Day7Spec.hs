...
testInput1 :: String
testInput1 = unlines [ "light red bags contain 1 bright white bag, 2 muted yellow bags."
...
testInput2 :: String
testInput2 = unlines [ "shiny gold bags contain 2 dark red bags."
